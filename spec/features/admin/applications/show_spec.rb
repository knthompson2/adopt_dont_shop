...
RSpec.describe 'show page' do
  before :each do
    ...
    @application_2 = Application.create!(name: "Frieda Thompson", street: "321 Sesame Street", city: "Daytona", state: "FL", zip_code: "12345", description: "I'm the best pet owner", status: "In Progress")
